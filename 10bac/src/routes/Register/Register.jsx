...
const Register = () => {
	...
	const handleFormSubmit = async (event) => {
		...
		if (password.length < 6)
			return setError("Parola trebuie să conțină minim 6 caractere!");
			...
			<div className="container">
				<form onSubmit={handleFormSubmit}>
					<div className="left">
						<h2>Cont nou</h2>
						<p>
							Pentru a te înregistra completează formularul
							acesta.
						</p>
						<p>
							Dacă ai deja cont, te rugăm sa te autentifici{" "}
							<a href="/autentificare">aici</a>!
						</p>
