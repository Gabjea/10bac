      ...
      <div className="container">
        <form onSubmit={handleFormSubmit}>
          ...
          <div className="right">
            ...
            <input ref={surnameRef} type="text" placeholder="Enter surname" name="surname" />
            ...
            <input ref={confPassRef} type="password" placeholder="Confirm Password" name="cpsw" />

            <button type="submit">Trimite</button>
            <span className="error" style={{ color: error === 'x' ? '#706fd3' : 'rgb(184, 44, 44)' }}>
              {error}
            </span>
          </div>
        </form>
