  ...
  return (
    <div className="Subiecte Profile">
      ...
      <form onSubmit={handleFormSubmit}>
        <input ref={titluRef} type="text" placeholder="Introdu titlul evenimentului" name="email" />

        <input ref={urlRef} type="text" placeholder="Introdu URL-ul evenimentului" name="psw" />
        <input ref={dateRef} type="datetime-local" placeholder="Introdu URL-ul evenimentului" name="psw" />
