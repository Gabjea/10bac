...
export default function Evaluare() {
  const handleFormSubmit = event => {
    ...
    for (let i = 1; i <= qLen; i++) {
      ...
      if (!elem[0].value || !elem[1].value || !elem[2].value || !elem[3].value) {
        // alert('smth is null!');
        return;
      }
  ...
  return (
    <div className="EvaluareAdmin">
      ...
      <br />
      <p>Pentru a adăuga un nou test de rezolvat te rugăm să completezi formularul de mai jos</p>
      <br />
      <form action="" onSubmit={handleFormSubmit}>
        <input id="materie_id" type="number" placeholder="ID-ul materiei" />
        <input id="capitol_id" type="number" placeholder="ID-ul capitolului" />
        <input id="nume-quiz" type="text" placeholder="Numele testului" />
