  ...
  return (
    <div className="Subiecte Profile">
      ...
      <form onSubmit={handleFormSubmit}>
        <input ref={titluRef} type="text" placeholder="Introdu titlul subiectului" name="email" />

        <input ref={urlRef} type="text" placeholder="Introdu URL-ul subiectului" name="psw" />
