...
const Tests = () => {
  ...
  return (
    <div className="Tests">
      ...
      <p>
        Te încurajăm să rezolvi subiectele și să încarci câte o fotografie cu rezolvările pentru a fi
        corectate de profesorii noștri.
      </p>
      <br />
      <br />
      {subDatas &&
        subDatas.map(subData => {
          return (
            <div>
              <h2>{subData.name}</h2>
              <iframe src={subData.link} style={{ width: '800px', height: '800px' }} title="english"></iframe>
              <br />
              <form
