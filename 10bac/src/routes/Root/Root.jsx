	...
	return (
		<div className="Root">
			...
			<p className="description">
				Bine ai venit! Pentru a începe te rugăm să alegi o materie pe
				care dorești să o studiezi.
				<br />
				Până acum avem <span>4</span> materii disponibile și un total de{" "}
				<span>22</span> de capitole!
			</p>
